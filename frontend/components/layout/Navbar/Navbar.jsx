  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 lg:mb-4 pb-4 shadow-sticky ${
        scrolling
          ? "bg-[#86DBD4] bg-opacity-40  backdrop-blur-sm"
    ...
    >
      <div className="flex items-center justify-between p-4 pb-0 font-medium">
        <a
          href={"/"}
          className="ml-8 text-2xl md:text-3xl text-white font-semibold"
        >
        ...
        <div className=" hidden md:flex md:justify-between md:w-3/2  gap-10">
          <div
            className="menu md:flex md:w-auto z-50 justify-between "
            id="navbar"
          >
          ...
          {/* darkmode */}
          <div className="text-white hidden  md:block hover:text-[#F6A9BD] hover:cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
