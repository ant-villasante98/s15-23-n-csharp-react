      ...
      <ul className="sm:grid sm:grid-cols-1 p-6 lg:m-10">
        {products.map((product) => (
          <li
            ...
            className="sm:h-64 content-between border-b border-gray-200 sm:grid sm:grid-cols-4 sm:grid-rows-5 md:auto-rows-auto sm:gap-x-4 sm:justify-items-center sm:mb-8 md:justify-between lg:justify-around md:grid-cols-5 md:grid-rows-3 md:h-auto md:pt-4 md:pb-4 md:gap-x-4 md:items-center md:content-center lg:grid lg:grid-cols-5 lg:items-center"
          >
            <img
              src={product.image}
            ...
            <div className="sm:row-start-1 sm:col-start-1">
              <p className="text-md font-bold text-pink-500 lg:text-lg">
                Producto:
              </p>
            </div>
